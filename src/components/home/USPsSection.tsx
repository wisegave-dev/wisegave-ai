...
import { DollarSign, Zap, Clock, Shield, Users, TrendingUp } from 'lucide-react';
...
export function USPsSection() {
  ...
  const colorClasses = {
    green: { bg: 'from-green-500/10 to-green-400/5', border: 'border-green-500/30', icon: 'from-green-400 to-emerald-400', hover: 'hover:border-green-500/50' },
    yellow: { bg: 'from-yellow-500/10 to-yellow-400/5', border: 'border-yellow-500/30', icon: 'from-yellow-400 to-amber-400', hover: 'hover:border-yellow-500/50' },
    blue: { bg: 'from-blue-500/10 to-blue-400/5', border: 'border-blue-500/30', icon: 'from-blue-400 to-cyan-400', hover: 'hover:border-blue-500/50' },
    purple: { bg: 'from-purple-500/10 to-purple-400/5', border: 'border-purple-500/30', icon: 'from-purple-400 to-pink-400', hover: 'hover:border-purple-500/50' },
    cyan: { bg: 'from-cyan-500/10 to-cyan-400/5', border: 'border-cyan-500/30', icon: 'from-cyan-400 to-blue-400', hover: 'hover:border-cyan-500/50' },
    red: { bg: 'from-red-500/10 to-red-400/5', border: 'border-red-500/30', icon: 'from-red-400 to-orange-400', hover: 'hover:border-red-500/50' }
  };

  return (
    <section id="guarantees" className="py-20 bg-gradient-to-b from-black via-[#0a0a0a] to-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl mb-4">
            Our <span className="bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Guarantees</span>
          </h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            We're committed to your success with industry-leading guarantees and support
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {usps.map((usp, index) => {
            ...
            return (
              ...
              >
                <div className={`w-12 h-12 bg-gradient-to-br ${colors.icon} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform backdrop-blur-sm`}>
