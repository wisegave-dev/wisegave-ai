          ...
          <div className="prose prose-invert max-w-none space-y-8">
            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
              ...
              <p className="text-gray-300">
                By accessing and using WiseGave AI services, you accept and
            ...
            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <p>
                  ...
                  subscription at any time. No refunds for partial months.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
              ...
              <div className="space-y-3 text-gray-300">
                <p>
                  <strong>5.1 Uptime:</strong> We guarantee 99.9% uptime for our
                  services.
                </p>
                <p>
            ...
            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
              ...
              <p className="text-gray-300">
                ...
                including software, algorithms, and documentation, remain the
                property of WiseGave AI. You are granted a limited,
                non-exclusive license to use the services for your business
                purposes.
              </p>
            </div>
            ...
            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
              ...
              <p className="text-gray-300">
                ...
                use or inability to use the service. Our total liability is
            ...
            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
              ...
              <div className="space-y-3 text-gray-300">
                ...
                <p>
                  ...
                  account for violation of these terms or fraudulent activity.
                </p>
                <p>
                  <strong>10.3 Effect:</strong> Upon termination, you will lose
                  access to the services and any data stored in the system.
                </p>
              </div>
            </div>
